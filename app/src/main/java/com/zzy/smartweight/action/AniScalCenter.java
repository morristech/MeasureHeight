...
public class AniScalCenter
{
	...
	public AniScalCenter(Context context)
	{
		visToInvisLeft = AnimationUtils.loadAnimation(context, R.anim.pocket_zoom_center_exit);
		invisTovisLeft = AnimationUtils.loadAnimation(context, R.anim.pocket_zoom_center_enter);
	}
	...
	public void AniScalCenterStart(ViewGroup vCurr, ViewGroup vNext, boolean bLeft)
	{
