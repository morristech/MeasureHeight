...
public class AniRotate3d extends Animation {
	...
	public AniRotate3d(float fromDegree, float toDegree, float depthZ, float centerX, float centerY) {
	...
	protected void applyTransformation(float interpolatedTime, Transformation t) {
		...
		Common.LogEx("applyTransformation in");
