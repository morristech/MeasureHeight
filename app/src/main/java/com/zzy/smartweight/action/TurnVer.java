...
public class TurnVer
{
	...
	public TurnVer()
	{
		...
		visToInvisRight.setPropertyName("rotationX");
		...
		invisToVisRight.setPropertyName("rotationX");
		...
		visToInvisLeft.setPropertyName("rotationX");
		...
		invisToVisLeft.setPropertyName("rotationX");
